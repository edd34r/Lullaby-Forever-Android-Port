...
class OptionsMenuState extends MusicBeatState
{
	...
	override public function create():Void
	{
		...
		categoryMap = [
			...
			'controls' => [
				[
					['Mobile Controls', openMobileSettings],
					['Hitbox Type', getFromOption], 
					['Hitbox Alpha', getFromOption],
				]
			]
		];
	...
	override public function update(elapsed:Float)
	{
		...
		if (controls.BACK || HSys.androidBack())
		{
	...
	public function openMobileSettings()
	{
		if (controls.ACCEPT)
		{
			FlxG.sound.play(Paths.sound('confirmMenu'));
