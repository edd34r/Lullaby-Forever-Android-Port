...
class PauseSubState extends MusicBeatSubState
{
	...
	public function new(x:Float, y:Float)
	{
		...
		if (!HSys.exists(Paths.getPath('pause/' + PlayState.SONG.song.toLowerCase()+ '/left' + PlayState.instance.pausePortraitPrefix[0] + '.png', IMAGE))) add(pausePortraitLeft);
		...
		if (!HSys.exists(Paths.getPath('pause/' + PlayState.SONG.song.toLowerCase()+ '/right' + PlayState.instance.pausePortraitPrefix[1] + '.png', IMAGE))) add(pausePortraitRight);
