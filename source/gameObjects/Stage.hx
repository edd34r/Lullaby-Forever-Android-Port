...
class Stage extends FlxTypedGroup<FlxSprite> {
	...
	public var bygonStuff:FlxSpriteGroup;
    ...
    public function new(?stage:String = 'stage') {
		...
		stageBuild = ScriptHandler.loadModule('assets/stages/$stage/$stage', exposure);
